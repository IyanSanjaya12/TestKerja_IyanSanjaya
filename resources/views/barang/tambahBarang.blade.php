...
<h2 style="color: #4CAF50;text-align: center;font-family: impact; font-weight: bold;">Tambah Data Barang</h2>

<div style="margin-left: 20%;margin-right: 20%;">
  <form action="{{url('simpanBarang')}}" method="POST">
    {{csrf_field()}}
    <label for="fname">Nama Barang</label>
    <input type="text" id="fname" name="nama" placeholder="Nama barang..">

    <label for="lname">Harga Barang</label>
    <input type="text" id="lname" name="harga" placeholder="Harga barang..">
